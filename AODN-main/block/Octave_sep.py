...
class OctaveConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, alpha=0.5, stride=1, padding=1, dilation=1
        ...
        self.stride = stride
        self.l2l = SeparableConv2d(in_channels=int(alpha * in_channels), out_channels=int(alpha * out_channels),
                                   kernel_size=kernel_size, stride=stride, padding=padding, dilation=dilation,  bias=bias)
        self.l2h = SeparableConv2d(int(alpha * in_channels), out_channels - int(alpha * out_channels),
                                   kernel_size, stride, padding, dilation,  bias)
        self.h2l = SeparableConv2d(in_channels - int(alpha * in_channels), int(alpha * out_channels),
                                   kernel_size, stride, padding, dilation,  bias)
        self.h2h = SeparableConv2d(in_channels - int(alpha * in_channels),
...
class FirstOctaveConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, alpha=0.5, stride=1, padding=1, dilation=1,
        ...
        # kernel_size = kernel_size[0]
        self.h2g_pool = nn.AvgPool2d(kernel_size=(2, 2), stride=2)
        self.h2l = SeparableConv2d(in_channels, int(alpha * out_channels),
                                   kernel_size, stride, padding, dilation,  bias)
        self.h2h = SeparableConv2d(in_channels, out_channels - int(alpha * out_channels),
                                   kernel_size, stride, padding, dilation,  bias)
...
class LastOctaveConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, alpha=0.5, stride=1, padding=1, dilation=1,
        ...
        self.l2h = SeparableConv2d(int(alpha * in_channels), out_channels,
                                   kernel_size, stride, padding, dilation,  bias)
        self.h2h = SeparableConv2d(in_channels - int(alpha * in_channels),
                                   out_channels,
                                   kernel_size, stride, padding, dilation,  bias)

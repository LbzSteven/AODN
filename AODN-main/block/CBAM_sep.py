...
class SpatialAttention(nn.Module):
    def __init__(self, kernel_size=7):
        ...
        self.conv1 = SeparableConv2d(2, 1, kernel_size, padding=padding, bias=False)
...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ):
        ...
        self.fc1 = SeparableConv2d(in_planes, in_planes // 16, 1, bias=False)
        self.relu1 = nn.ReLU()
        self.fc2 = SeparableConv2d(in_planes // 16, in_planes, 1, bias=False)
